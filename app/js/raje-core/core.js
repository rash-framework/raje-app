...
tinymce.PluginManager.add('raje_lists', function (editor, url) {
  ...
  let list = {
    ...
    addListItem: function () {
      ...
      // Check if the cursor is at the end of the last node
      console.log(p.contents().index(tinymce.activeEditor.selection.getNode()))
